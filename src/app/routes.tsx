...
const InvitationManagement = lazy(() => import('@app/modules/InvitationManagement/InvitationManagement'));
    ...
    <Router>
      <React.Suspense fallback={<Loading />}>
        <Switch>
          ...
          <Route path="/invitation-management" component={InvitationManagement} exact/>
        </Switch>
      </React.Suspense>
    </Router>
  );
