...
export interface SchedulerProps {
    ...
    updateEventStart(schedulerData: SchedulerData, event: any, newStart: any): void;
    updateEventEnd(schedulerData: SchedulerData, event: any, newEnd: any): void;
    moveEvent(schedulerData: SchedulerData, event:any, slotId:any, slotName:any, start: any, end: any): void;
    newEvent:any;
    onScrollLeft(schedulerData: SchedulerData, schedulerContent:any, maxScrollLeft:any):void;
    onScrollRight(schedulerData: SchedulerData, schedulerContent:any, maxScrollLeft:any):void;
    onScrollTop(schedulerData: SchedulerData, schedulerContent:any, maxScrollTop:any):void;
    onScrollBottom(schedulerData: SchedulerData, schedulerContent:any, maxScrollTop:any):void;
    toggleExpandFunc(schedulerData: SchedulerData, slotId:any):void;
}
